      ...
      <div className="w-full max-w-3xl bg-zinc-900 p-6 relative ">
        ...
        <div className="flex justify-between items-center my-6">
          <div className="flex gap-3">
            <button
              ...
              className="bg-black  border-rose-500 border cursor-pointer hover:scale-[1.02] transition-transform font-simplefont text-white px-4 py-2 rounded"
            >
              History
            </button>
            <button
        ...
        <div className="border rounded p-4 border-gray-700 flex flex-col h-[65vh] overflow-hidden">
          <div className="flex-1 overflow-y-auto pb-16">
            ...
            {activeTab === "total" && <Total expenses={expenses} />}
            {activeTab === "category" && <Category expenses={expenses} />}
          </div>
        </div>
        ...
        <div className="absolute bottom-9 right-8">
          <button
            ...
            className="bg-rose-700 flex items-center justify-center text-white px-12 py-4 font-simplefont font-bold font-lg cursor-pointer hover:scale-[1.05] transition-transform rounded-full"
          >
            <img
              src={billIcon}
              alt="Add Expense"
